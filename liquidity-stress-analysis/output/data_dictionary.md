# Data dictionary — Iowa liquidity stress benchmarking

One row per district per fiscal year. Two datasets share these fields:
`district_year_master.csv` (statewide screen, FY2017-2024) and `focus_peer_detail.csv` (15 audited districts, FY2020-2025).

| Field | Source | Definition | Formula | Limitations | Consistently available |
|---|---|---|---|---|---|
